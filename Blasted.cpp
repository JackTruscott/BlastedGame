...
//printWithDelay function, prints a string with a delay between each character
...
//titleSequence function, displays the title screen with a connecting message and some fun animations
void titleSequence() {
...
//startOrStop function, checks for enter or escape key press, and exits the game or continues running the code
void startOrStop() {
